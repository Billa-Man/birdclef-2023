...
def main():
    ...
    print(f"MAIN: Dataset generated.")
    ...
    print(f"MAIN: DataLoader created.")
    ...
    print(f"MAIN: Model training started.")
    ...
    print(f"MAIN: Model training finished. Process took {end-start} seconds.")
